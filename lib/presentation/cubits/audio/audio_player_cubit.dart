...
class AudioPlayerCubit extends Cubit<AudioPlayerState> {
  ...
  // audio players
  // intro music
  final _introMusicSource = AssetSource(AppAssets.introMusic);
  final AudioPlayer _introMusicPlayer = getAudioPlayer();

  // theme music player
  final _themeMusicSource = AssetSource(AppAssets.themeMusic1);
  ...
  void _init() {
    ...
    _timer = Timer(AppConstants.kMS200, () async {
      // theme music setup
      await _introMusicPlayer.setSource(_introMusicSource);
      await _introMusicPlayer.setVolume(_maxThemeVolume);
  ...
  void playIntroMusic() {
    unawaited(_introMusicPlayer.play(_introMusicSource));
  }
